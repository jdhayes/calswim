...
class WebDB:
    ...
    def get_items(self):
        ...
        return "<form action='' method='post'><a id='add' href=''>Add</button> | <input type='submit'>Delete</input><table><thead><tr>"+ "</th><th>".join(columns) +"</tr></thead><tbody>"+ html_rows +"</tbody></table></form>"
